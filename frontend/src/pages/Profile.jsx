...
export default function Profile() {
  ...
  const handleSelectBannerMovie = async (movie) => {
    ...
    setEditFormHeaderImage(nextHeaderImage);
    setIsPickingBannerMovie(false);
  };
  ...
  return (
    <div className="flex flex-col w-full bg-slate-950 text-slate-50 min-h-screen">
      {/* Header */}
      <div className="w-full h-32 sm:h-40 md:h-48 overflow-hidden relative">
        <img src={user.headerImage} alt="Header" className="w-full h-full object-cover object-top opacity-30" />
      ...
      <div className="max-w-7xl mx-auto px-6 py-6 flex flex-col md:flex-row gap-6 items-start">
        ...
        <div className="flex-shrink-0 w-full md:w-1/3 flex flex-col gap-4">
          ...
          <div className="flex flex-col items-center md:items-start gap-2">
            ...
            <p className="text-slate-300 text-sm sm:text-base line-clamp-4 h-[96px] text-center md:text-left">{user.bio || "No description yet."}</p>
            <div className="flex flex-wrap gap-1 justify-center md:justify-start">
          ...
          <div className="bg-slate-900 rounded-lg border border-slate-800 w-full max-w-2xl p-4 relative z-10 modal-content modal-content-opening">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <div className="mt-2 w-full h-20 rounded overflow-hidden border border-slate-800 bg-slate-900">
                  <img
